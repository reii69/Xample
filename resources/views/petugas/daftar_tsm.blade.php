          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li  class=" active"><a class="nav-link" href="petugas.daftar_tsm"><i class="fas fa-motorcycle"></i> <span>TSM</span></a></li>
          ...
          <div class="card w-100">
            ...
            <div class="card-body p-0">
                <div class="table-responsive-xl">
                  ...
                  <form action="{{ route('users.deleteSelected10') }}" method="POST">
                    @csrf
                    @method('DELETE')
                    @if (!$users->isEmpty())
