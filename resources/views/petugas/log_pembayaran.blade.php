      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            <li class="menu-header">LOG PEMBAYARAN</li>
            ...
            <li class="active"><a class="nav-link" href="admin.log_pembayaran"><i class="fas fa-history"></i> <span>LOG PEMBAYARAN</span></a></li>
            <li class="dropdown ">
          ...
          <ul class="sidebar-menu">
            <li class="menu-header">LOG PEMBAYARAN</li>
            <li ><a class="nav-link" href="/dashboard"><i class="fas fa-info"></i> <span>DASHBOARD</span></a></li>
            <li class=" active"><a class="nav-link" href="petugas.log_pembayaran"><i class="fas fa-history"></i> <span>LOG PEMBAYARAN</span></a></li>
            <li class="dropdown ">
              <a href="#" class="nav-link has-dropdown"><i class="fas fa-user"></i><span>DAFTAR SISWA</span></a>
              <ul class="dropdown-menu">
...
<div class="main-content">
  <section class="section">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="siswa.log_pembayaran">Log Pembayaran</a></div>
    </div>
      ...
      <div class="section-body">
        ...
        <div class="row">
          ...
          <div class="card w-100">
           ...
           <div class="container">
            <br>
                  <form action="{{ route('generateDataBaru1') }}" method="POST">
                    @csrf
                    <button type="submit"class="btn btn-outline-danger mr-2">+ Generate Data Baru</button>
                  </form>    
                  <br>
                @php
            ...
            @endphp
                ...
                <table class="table table-striped table-dark w-100" id="sortable-table">
                    ...
                    <tbody>
                        @if ($users->isEmpty())
                            <tr>
                                <td colspan="8">Tidak ada data Log SPP.</td>
                            </tr>
                        @else
                            @foreach ($users as $log)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $log->user->jurusan }}</td> <!-- Menggunakan jurusan dari relasi User -->
                                    <td>{{ $log->bulan }}</td>
                                    ...
                                    <td>
                                      <form action="{{ route('log_pembayaran.destroy1', $log->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
