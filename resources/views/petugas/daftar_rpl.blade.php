      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            <li class="menu-header">DAFTAR SISWA RPL</li>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                <li class="active"><a class="nav-link" href="admin.daftar_rpl"> <i class="fas fa-laptop-code"></i> <span>RPL</span></a></li>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              <a href="#" class="nav-link has-dropdown"><i class="fas fa-user"></i><span>DAFTAR SISWA</span></a>
              <ul class="dropdown-menu">
                <li  class=" active"><a class="nav-link" href="petugas.daftar_rpl"> <i class="fas fa-laptop-code"></i> <span>RPL</span></a></li>
...
<div class="section-header-breadcrumb">
  ...
  <div class="breadcrumb-item"><a href="admin.daftar_rpl">RPL</a></div>
</div>
      ...
      <div class="card w-100">
        ...
        <div class="card-body p-0">
            <div class="table-responsive-xl">
              ...
              <form action="{{ route('users.deleteSelected') }}" method="POST">
                @csrf
                @method('DELETE')
                @if (!$users->isEmpty())
