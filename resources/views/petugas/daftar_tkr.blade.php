      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            <li class="menu-header">DAFTAR SISWA TKR</li>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li  class=" active"><a class="nav-link" href="admin.daftar_tkr"><i class="fas fa-car"></i> <span>TKR</span></a></li>
              </ul>
            </li>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li  class=" active"><a class="nav-link" href="petugas.daftar_tkr"><i class="fas fa-car"></i> <span>TKR</span></a></li>
              </ul>
            </li>
            <li><a class="nav-link" href="calender"><i class="fas fa-calendar-alt"></i> <span>KALENDER</span></a></li>
          </ul>
...
<div class="main-content">
  <section class="section">
    ...
    <h1>DAFTAR SISWA TKR</h1>
    <div class="section-header-breadcrumb">
      <div class="breadcrumb-item active"><a href="dashboard">Dashboard</a></div>
      <div class="breadcrumb-item">Daftar Siswa</div>
      <div class="breadcrumb-item"><a href="admin.daftar_tkr">TKR</a></div>
    </div>
          ...
          <div class="card w-100">
            ...
            <div class="card-body p-0">
                <div class="table-responsive-xl">
                  ...
                  <form action="{{ route('users.deleteSelected8') }}" method="POST">
                    @csrf
                    @method('DELETE')
                    @if (!$users->isEmpty())
