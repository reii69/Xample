      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            <li class="menu-header">DAFTAR PEKERJA</li>
            <li><a class="nav-link" href="/dashboard"><i class="fas fa-info"></i> <span>DASHBOARD</span></a></li>
            <li class="active"><a class="nav-link" href="admin.daftar_pekerja"><i class="fas fa-users"></i> <span>DAFTAR PEKERJA</span></a></li>
...
<div class="main-content">
  <section class="section">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="admin.daftar_pekerja">Daftar Pekerja</a></div>
      ...
      <div class="section-body">
        ...
        <div class="row">
          ...
          <div class="container">
            <div class="d-flex">
              <a href="#" class="btn btn-outline-danger mr-2" data-toggle="modal" data-target="#exampleModal">+ Tambah Admin</a>
              <a href="#" class="btn btn-outline-danger mr-2" data-toggle="modal" data-target="#exampleModal1">+ Tambah Petugas</a>
          </div></div>    <br>
          @if(session('success'))
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                <span class="text-danger">Anda tidak memiliki izin untuk menghapus</span>
                                @endif
                            </td>
                        </tr>
                        @endforeach
        ...
        <ul class="pagination justify-content-end ml-auto container">
          {{-- Tombol Previous --}}
                      ...
                      <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                ...
                                <input id="frist_name" type="text" class="form-control" name="name"  required autofocus>
                            </div>
                            <div class="form-group col-6">
                        ...
                        <div class="form-group">
                            ...
                            <input id="password" type="password" class="form-control pwstrength" required data-indicator="pwindicator" name="password_confirmation">
      ...
      <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Form untuk tambah admin -->
                    <form method="POST" action="{{ route('users.store1') }}">
                      @csrf
                      <!-- Default role -->
